...
export type TimelineHazardKind = Extract<TrackEventKind, 'gate' | 'aperture' | 'halfwall' | 'blade' | 'cross' | 'bastion'>;
...
const HAZARD_KINDS = new Set<TrackEventKind>(['gate', 'aperture', 'halfwall', 'blade', 'cross', 'bastion']);
